...
public class AutoSuggest
    ...
    private static final String TAG = "AutoSuggest";
     ...
     */
    public AutoSuggest(Context context, GoogleApiClient geoDataClient,
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()){
            ...
            if(!status.isSuccess()){
                ...
                Log.e(TAG, "Error getting Autoprediction API call: " + status.toString());
